    ...
    return (
        <div className="footer">  
            <Grid container spacing={0}>
                <Grid item xs={2}>
                    <div className="title" style={{height: '320px', backgroundColor: '#b2e4fa', padding: '50px'}}>
                ...
                <Grid item xs={3}>
                    <div className="lastTitle" style={{width: '380px', height: '370px', backgroundColor: '#b2e4fa', paddingBlockStart: '50px', paddingRight: '50px',}}>
                        <h3 className="fifth">
                            LevelUp Works
                        </h3>
                        <p className="col5">
